...
function CopyButton({ copyText }: { copyText: string | undefined }) {
  ...
  return <Tooltip open={open} onOpenChange={setOpen}>
    <TooltipTrigger asChild={true} onClick={onClick}>
      <button ref={ref} className="focus:border-sky-500 hover:bg-gray-50 stroke-gray-400 hover:shadow-sm rounded-md shadow-sm px-1 mt-1 border border-gray-300 focus:outline-none focus:ring-sky-500 focus:ring-1">
