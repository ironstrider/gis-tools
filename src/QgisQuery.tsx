...
function OutputField({
  ...
  return (<>
    ...
    {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg> */}
    ...
    <div className="grid grid-cols-[auto_1fr] gap-2 mt-1">
      <button className="focus:border-sky-500 hover:bg-gray-50 stroke-gray-400 hover:shadow-sm rounded-md shadow-sm px-1 mt-1 border border-gray-300 focus:outline-none focus:ring-sky-500 focus:ring-1">
        <svg className="w-8 group-hover:rotate-[-4deg] group-hover:stroke-sky-500" fill="none" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div className="container mx-auto">
      ...
      <div className="mt-6 grid gap-6 grid-cols-1 md:grid-rows-[auto_1fr] md:grid-cols-[1fr_auto_3fr]">
        ...
        <div className="col-span-1">
          <OutputField label="Numeric" value={numericQuery ?? undefined} placeholder={numericPlaceholder} />
        </div>

        <div className="col-span-1">
          <OutputField label="String" value={stringQuery ?? undefined} placeholder={stringPlaceholder} />
        </div>
      </div>
    </div>
  )
